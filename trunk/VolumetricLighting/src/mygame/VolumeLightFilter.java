...
public class VolumeLightFilter extends Filter {
    ...
    public VolumeLightFilter(SpotLight spot, int resolution, Node rn) {
        ...
        this.lightCam.setFrustumPerspective(this.light.getSpotOuterAngle() * FastMath.RAD_TO_DEG * 2.0f, 1, 2f, this.light.getSpotRange());
    ...
    protected void initFilter(AssetManager manager, RenderManager renderManager, ViewPort vp, int w, int h) {
        ...
        volumetricLight_mat = new Material(manager, "MatDefs/VolumetricLight.j3md");
...
//            }
        ...
        material = new Material(manager, "MatDefs/VolumetricLightFilter.j3md");
        material.setTexture("LightingVolumeTex", lightVolumePass.getRenderedTexture());
        shadowVolumeRenderer.setPostShadowMaterial(volumetricLight_mat);
    }
